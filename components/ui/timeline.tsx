  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground max-w-4xl">
          Future Development Roadmap
        </h2>
        <p className="text-muted-foreground text-sm md:text-base max-w-2xl">
          Our vision for enhancing the MultiversX SDK Tester with new features, improvements, and capabilities over time.
        </p>
      </div>
